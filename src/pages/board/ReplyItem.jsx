...
function ReplyItem({ item }){
  return (
    <div className="shadow-md rounded-1g p-4 mb-4">
      <div className="flex justify-between iems-center mb-2">
        ...
        <time className="text-gray-500" dateTime={item.createdAt}></time>
      </div>
      <pre className="whitespance-pre-wrap text-sm">{ item.comment }</pre>
